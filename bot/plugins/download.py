...
async def _telegram_file(client, message):
  ...
  if message.document:
      ...
      await sent_message.edit(Messages.DOWNLOAD_TG_FILE.format(message.photo.file_name, humanbytes(message.photo.file_size), message.photo.file.mime_type))  LOGGER.info(f'Download:{user_id}: {file.file_id}')
  try:
